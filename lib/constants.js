...
/** Riferimento file ecosystem per-app; in produzione PM2 usa `/home/ubuntu/ecosystem.config.js` (tutte le app). */
const ECOSYSTEMS = [
...
const WEB_SITES = [
  ...
  { name: 'Gestione Casa', url: 'https://gestione-casa.duckdns.org', port: 3003, pm2: 'gestione-casa', kind: 'app' },
  { name: 'Control Room', url: 'https://matteroma.duckdns.org', port: 3005, pm2: 'control-room', kind: 'app' },
  { name: 'Scoutbet Pro', url: 'https://scoutbetpro.duckdns.org', port: 3006, pm2: 'scoutbet-pro', kind: 'app' },
  {
    name: 'GENERATOR (D&D)',
